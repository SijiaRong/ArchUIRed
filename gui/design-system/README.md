...
Brand marks are handled separately from typography. The ArchUI `A` logo mark is a repo-owned vector asset with Figma preview frames and committed document exports; it is not treated as a font glyph or a fifth text lane.
