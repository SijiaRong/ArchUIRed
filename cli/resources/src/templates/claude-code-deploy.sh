...
# deploy.sh — Claude Code adapter deployment script (embedded in the CLI)
# Executed by `archui init` with REPO_ROOT set to the ArchUIRed package root.
#
# Reads all content from canonical template directories under REPO_ROOT:
